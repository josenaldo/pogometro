...
const TITLE_ARCHETYPE_PATTERNS = [
    ...
    { key: 'acougueiro', pattern: /\bacougueir(?:o|a|os|as)\b/ },
    { key: 'marceneiro', pattern: /\bmarceneir(?:o|a|os|as)\b/ },
    { key: 'pedreiro', pattern: /\bpedreir(?:o|a|os|as)\b/ },
    { key: 'mecanico', pattern: /\bmecanic(?:o|a|os|as)\b/ },
    { key: 'eletricista', pattern: /\beletricistas?\b/ },
    { key: 'encanador', pattern: /\bencanador(?:a|es|as)?\b/ },
    { key: 'serralheiro', pattern: /\bserralheir(?:o|a|os|as)\b/ },
    { key: 'soldador', pattern: /\bsoldador(?:a|es|as)?\b/ },
    { key: 'funileiro', pattern: /\bfunileir(?:o|a|os|as)\b/ },
    { key: 'montador', pattern: /\bmontador(?:a|es|as)?\b/ },
]
